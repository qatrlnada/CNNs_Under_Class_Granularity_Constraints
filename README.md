...
\- artifacts/models/ 
     ...
     Contains md file with the directions of the models weights location under the releases section 
...
the releases link: https://github.com/qatrlnada/CNNs_Under_Class_Granularity_Constraints/releases/tag/v1.0-models
